...
from openpype.hosts.fusion.api.action import SelectToolAction
...
class ValidateInstanceInContextHoudini(pyblish.api.InstancePlugin,
    ...
    def process(self, instance):
        ...
        if (asset, task) != context:
            context_label = "{} > {}".format(*context)
            instance_label = "{} > {}".format(asset, task)
    ...
    def repair(cls, instance):
        ...
        created_instance[asset_name_attr] = context_asset
    ...
    def get_context(instance):
        ...
        return context.data["asset"], context.data["task"]
