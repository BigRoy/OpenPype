...
def create_yeti_variable(yeti_shape_node,
                         attr_name,
                         value=None,
                         force_value=False):
    """Get user defined yeti user variables for a `pgYetiMaya` shape node.
...
def _create_vector_yeti_user_variable(yeti_shape_node, attr_name):
...
def _create_float_yeti_user_variable(yeti_node, attr_name):
